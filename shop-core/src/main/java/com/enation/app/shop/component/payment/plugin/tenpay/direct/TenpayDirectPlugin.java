 ...
 */
@Component
public class TenpayDirectPlugin extends AbstractPaymentPlugin implements IPaymentPlugin {
	...
	public List<ConfigItem> definitionConfigItem() {
		...
		ConfigItem seller_tenpaybidItem = new ConfigItem();
		seller_tenpaybidItem.setName("tenpaybid");
		seller_tenpaybidItem.setText("财付通商户号(10位数字)");
		ConfigItem seller_tenpaykeyItem = new ConfigItem();
		seller_tenpaykeyItem.setName("tenpaykey");
		seller_tenpaykeyItem.setText("财付通密钥");
		list.add(seller_tenpaykeyItem);
		list.add(seller_tenpaybidItem);
		return list;
	}
