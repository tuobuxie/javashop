...
public class AlipayMarketingCdpAdvertiseCreateModel extends AlipayObject {
	...
	private static final long serialVersionUID = 2853257148338157811L;
	...
	/**
	 * 广告展示规则。该规则用于商家设置对用户是否展示广告的校验条件。CDP_OPEN_MERCHANT目前仅支持商家店铺规则，shop_id为支付宝店铺ID，商家登录https://b.alipay.com/查询。
	 */
	@ApiField("ad_rules")
